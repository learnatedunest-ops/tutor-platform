...
// Single source of truth for the EduNest logo.
// To update: compress new image, upload with `manus-upload-file --webdev`, then change only this line.
export const LOGO_URL = "/manus-storage/edunest-logo-small_2b84d7c3.png";
