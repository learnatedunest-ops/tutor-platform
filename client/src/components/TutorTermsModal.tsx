    ...
    <Dialog open={open} onOpenChange={onClose}>
      <DialogContent className="max-w-2xl max-h-[85vh] flex flex-col">
        <DialogHeader>
          ...
          <p className="text-sm text-muted-foreground">Please read carefully before registering as a tutor</p>
        </DialogHeader>
        <ScrollArea className="flex-1 pr-4">
          <div className="space-y-6 text-sm text-foreground pb-4">
            ...
            <section>
              ...
              <p>By registering as a tutor on EduNest, you agree to abide by these terms and conditions in full. EduNest reserves the right to update these terms at any time with notice provided via email.</p>
            </section>

            {/* Section 2 — Fee & Payment Policy */}
            <section>
              <h3 className="font-bold text-base text-orange-600 mb-2">2. Fee & Payment Policy</h3>
              <div className="bg-orange-50 border border-orange-200 rounded-lg p-3 mb-3">
                <p className="font-semibold text-orange-800">⚠️ Important: First Month Deduction</p>
                <p className="mt-1 text-orange-700">EduNest deducts <strong>40% of the tuition fee</strong> for the first month as a platform service charge. From the second month onwards, <strong>no deductions</strong> are made — you receive 100% of the agreed tuition fee directly.</p>
              </div>
            ...
            <section>
              <h3 className="font-bold text-base text-orange-600 mb-2">3. Tutor Conduct Guidelines</h3>
              <div className="space-y-3">
                ...
                <div>
                  <p className="font-semibold mb-1">🕐 Punctuality</p>
                  <ul className="list-disc pl-5 space-y-1">
            ...
            <section>
              <h3 className="font-bold text-base text-orange-600 mb-2">4. Demo Class Policy</h3>
              <ul className="list-disc pl-5 space-y-1">
            ...
            <section>
              <h3 className="font-bold text-base text-orange-600 mb-2">5. Profile & Verification</h3>
              <ul className="list-disc pl-5 space-y-1">
            ...
            <section>
              <h3 className="font-bold text-base text-orange-600 mb-2">6. Account Termination</h3>
              <p>EduNest reserves the right to suspend or terminate your account for violation of these terms, misconduct, repeated cancellations, or any behaviour deemed harmful to students, parents, or the EduNest brand.</p>
            </section>
