...
const tutorsData: Record<string, {
  ...
  "priya-verma": {
    ...
    reviewsList: [
      { name: "Aryan K.", rating: 4, date: "March 2025", text: "Priya ma'am is exceptional! She explained integration in a way that finally made sense. My board exam score jumped from 72 to 94.", subject: "Mathematics" },
      ...
      { name: "Rohan M.", rating: 4, date: "January 2025", text: "Cleared my JEE Mains with 97 percentile in Maths. Priya ma'am's structured approach and regular mock tests were key.", subject: "JEE Maths" },
