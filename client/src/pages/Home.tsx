        ...
        <div className="container relative z-10 py-16 lg:py-24">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative hidden lg:block">
              ...
              <img
                src="/api/img/hero-tutor-student_bfec5a06.png"
              ...
              <div className="absolute -top-5 -right-5 z-20 bg-white rounded-2xl p-4 shadow-2xl" style={{ minWidth: "160px" }}>
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-xs" style={{ color: "oklch(0.5 0.01 270)", fontFamily: "'Nunito', sans-serif" }}>From 1,200+ reviews</div>
                  </div>
                </div>
              </div>
            </div>
          ...
          {activeTab === "students" ? (
            <div className="grid lg:grid-cols-2 gap-12 items-center max-w-5xl mx-auto">
              <div className="relative">
                ...
                <img
                  src="/api/img/student-benefit_13c705d9.png"
